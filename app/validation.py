...
decoupage en 3 fonction : 
    - :: w3c_validator :: Envoie et recupère la réponse de w3c validator
    - :: parser_w3c_result ::Parse la réponse et retourne un dictionnaire
    - A définir : Envoie un score 
...
def w3c_validation(HTMLcode):
    ...
    @param {str} : le code w3c à valider
    @result {resquest.reponse} : une clé score qui contient un int et une clé erreurs qui contient les résultats des erreurs.
